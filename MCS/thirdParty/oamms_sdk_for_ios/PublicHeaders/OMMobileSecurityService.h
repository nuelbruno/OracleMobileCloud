...
/*
 ...
 MODIFIED   (MM/DD/YY)
 vismishr    09/02/15 - Added API to copy state of from mss to another
 vismishr    08/10/15 - Added API to return auth context without validity check
...
/**
 * This method copies the context and state information from source
 * OMMobileSecurityService object to the calling object.
 *
 * @param sourceMss source object whose state needs to be copied
 *
 * @return void
 */
- (void)copyFrom:(OMMobileSecurityService *)sourceMss;
...
/**
 * Returns existing authentication context, if it is available in cache or in
 * keychain item. Authentication context's validity API should be called on the
 * returned context to check it's validity.
 *
