...
/**
 ...
 the analytics service could not create a network connection to the Analytics server.
 See the values in the `userInfo` dictionary.
 */
extern NSInteger const OMCAnalyticsNetworkConnectionError;

/**
 A key to the `userInfo` dictionary in the `NSError` generated when
 the analytics service could not create a network connection to the Analytics server.
 The corresponding value is the `NSURLRequest` that generated the error.
 */
extern NSString* const OMCAnalyticsNetworkConnectionErrorRequest;
 ...
 */
extern NSString* const OMCAnalyticsNetworkConnectionErrorFileURL;
