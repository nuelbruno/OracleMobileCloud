...
/**
 The mobile backend manager is the entry point to the Oracle Mobile Cloud SDK.
 ...
 */
@property (readonly, nonatomic) OMCMobileBackend* defaultMobileBackend;
...
/**
 ...
 produced by the Oracle Mobile Cloud SDK. The log level can be set to one of the following
 ...
 */
- (OMCMobileBackend*)mobileBackendForName:(NSString*)name;
...
/**
 The mobile backend manager's `syncExec` mode property name.
 */
extern NSString* const OMCMobileBackendManagerSynchronousExecutionPropertyName;

/**
 The mobile backend manager's `syncExec` mode default value (`NO`).
 */
extern BOOL const OMCMobileBackendManagerSynchronousExecutionDefault;
