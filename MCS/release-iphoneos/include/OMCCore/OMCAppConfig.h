...
/**
 Application configuration stored on the MCS.
 ...
 */
- (NSNumber*)numberForProperty:(NSString*)property default:(NSNumber*)defaultValue;
 ...
 */
- (NSString*)stringForProperty:(NSString*)property default:(NSString*)defaultValue;
