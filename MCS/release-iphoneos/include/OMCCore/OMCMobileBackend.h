 ...
 */
@property (readonly, nonatomic, weak) OMCMobileBackendManager* manager;
...
/**
 The mobile backend's custom code path, which is appended to the `url` to
 form the `customCodeURL`. The default custom code path is `OMCMobileBackendCustomCodePathDefault`.
 */
@property (copy) NSString* customCodePath;

/**
 The mobile backend's custom code URL, upon which requests such as HTTP URLs are
 ...
 */
- (OMCServiceProxy*)serviceProxyForClass:(Class)serviceProxyClass;
...
/**
 ...
 @see -[OMCMobileBackend appConfigWithCompletionHandler:]
 */
typedef void (^OMCAppConfigCompletionBlock)(OMCAppConfig* appConfig, NSError* error);
 ...
 */
typedef void (^OMCURLRequestCompletionBlock)(NSMutableURLRequest* urlRequest, NSError* error);
 ...
 */
- (NSMutableURLRequest*)urlRequestWithPath:(NSString*)relativePath;
 ...
 */
- (void)urlRequestWithPath:(NSString*)relativePath
 ...
 */
- (NSMutableURLRequest*)platformURLRequestWithPath:(NSString*)relativePath;
 ...
 */
- (void)platformURLRequestWithPath:(NSString*)relativePath
                 completionHandler:(OMCURLRequestCompletionBlock)completionHandler;
 ...
 */
- (NSMutableURLRequest*)customCodeURLRequestWithPath:(NSString*)relativePath;
 ...
 */
- (void)customCodeURLRequestWithPath:(NSString*)relativePath
                   completionHandler:(OMCURLRequestCompletionBlock)completionHandler;
 ...
 */
- (NSMutableURLRequest*)appConfigURLRequestWithPath:(NSString*)relativePath;
 ...
 */
- (void)appConfigURLRequestWithPath:(NSString*)relativePath
                  completionHandler:(OMCURLRequestCompletionBlock)completionHandler;
...
/**
 ...
 and the diagnostics context state.
...
/**
 Adds the receiver's HTTP headers to the specified URL request.
 The headers will include the application key, authorization settings,
 and the diagnostics context state.
 ...
 @see addHTTPHeadersToRequest:completionHandler:
 */
